    ...
    <>
      ...
      <div className="w-[90%] mx-auto mt-6">
        {fetchLoading ? (
          ...
          blogs.map((blog) => (
            <div key={blog._id} className=" flex flex-col md:flex-row p-4 border rounded-lg mb-4">

              <div className="w-[80%] mx-auto flex flex-col-reverse md:flex md:flex-row-reverse mt-7 mb-7" key={blog.id}>
                <div className="w-[80%] mx-auto mt-4 md:mt-3 mb-2">
                  ...
                  <p className="font-semibold text-lg text-gray-600">{blog.description}</p>
